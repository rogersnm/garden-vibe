  ...
  categories: [
    {
      ...
      entries: [
        ...
        { id: 'CF7', firstPlace: 'ian f', secondPlace: 'ken m', thirdPlace: 'chris s' },
      ],
    },
    {
      name: 'Roses',
      ...
      entries: [
        ...
        { id: 'R4', firstPlace: 'dave c', secondPlace: 'sallg', thirdPlace: 'Caroll' },
      ],
    },
    {
      name: 'Vege',
      ...
      entries: [
        ...
        { id: 'v7', firstPlace: 'hiary e', secondPlace: 'ken e', thirdPlace: 'Dan' },
        ...
        { id: 'V12', firstPlace: 'ash scot', secondPlace: 'caroll', thirdPlace: 'chris s' },
      ],
    },
    {
      name: 'fruit',
      ...
      entries: [
        ...
        { id: 'f4', firstPlace: 'ian f', secondPlace: '', thirdPlace: '' },
        { id: 'f5', firstPlace: 'dave c', secondPlace: '', thirdPlace: '' },
        { id: 'f6', firstPlace: 'caroll', secondPlace: 'caroll', thirdPlace: 'angela' },
      ],
    },
    {
      ...
      entries: [
        ...
        { id: 'PC4', firstPlace: 'jan f', secondPlace: 'chris', thirdPlace: 'lyn p' },
    ...
    },
    {
      ...
      entries: [
        ...
        { id: 'FD2', firstPlace: 'jayne S', secondPlace: 'caroll', thirdPlace: 'hilary' },
        { id: 'FD3', firstPlace: 'caroll', secondPlace: 'jayne', thirdPlace: '' },
        { id: 'FD4', firstPlace: 'jayne S', secondPlace: 'caroll', thirdPlace: '' },
        { id: 'FD5', firstPlace: 'caroll', secondPlace: 'jo goody', thirdPlace: 'val white' },
      ],
    },
    {
      name: 'Home baking',
      ...
      entries: [
        { id: 'H1', firstPlace: 'sall g', secondPlace: '', thirdPlace: 'hilary' },
        { id: 'H2', firstPlace: '', secondPlace: 'hilary', thirdPlace: '' },
        { id: 'H3', firstPlace: 'dave c', secondPlace: 'dan', thirdPlace: '' },
        { id: 'H4', firstPlace: '', secondPlace: '', thirdPlace: '' },
        { id: 'H5', firstPlace: 'sally g', secondPlace: 'chris s', thirdPlace: 'angela' },
      ],
    },
  ],
};
